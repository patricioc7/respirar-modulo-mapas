            ...
            <div className='mapPopupContent'>
                ...
                <div className='detallesEstacion'>
                    <ListGroup>
                        ...
                        <ListGroup.Item><strong>Calidad pm25:</strong>  {station.pm25}</ListGroup.Item>
                    </ListGroup>
                </div>
                ...
                <Modal.Body className="bg-primary">
                    <div className='controlsContainer'>
                        <Row>
                            ...
                            <Form.Group as={Col}>
                                <Form.Select className='parametrosSelect' size="sm" onChange={(e) => setParameter(e.target.value)}>
                                    {station?.availableParams?.length && station?.availableParams?.map(parameter => {
                                        return (<option key={parameter} value={parameter}>{parameter}</option>)
                                    })}

                                </Form.Select>
                            </Form.Group>
                            <Form.Group as={Col}>
                                <Button className="botonActualizar" onClick={()=> fetchHistoryData()}>Actualizar</Button>
                            </Form.Group>
                        </Row>
                    </div>
